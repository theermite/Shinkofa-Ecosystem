/**
 * ImagePairs - Web Component Entry Point
...
class ErmiteImagePairs extends HTMLElement {
  ...
  private render() {
    ...
    this.root.render(
      React.createElement(ImagePairs, {
        ...props,
...
if (!customElements.get('ermite-image-pairs')) {
  customElements.define('ermite-image-pairs', ErmiteImagePairs)
}

export { ImagePairs } from './ImagePairs'
export default ErmiteImagePairs
