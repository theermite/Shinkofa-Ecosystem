/**
 * MultiTask - Web Component Entry Point
...
class ErmiteMultiTask extends HTMLElement {
...
if (!customElements.get('ermite-multi-task')) {
  customElements.define('ermite-multi-task', ErmiteMultiTask)
}

export { MultiTask } from './MultiTask'
export default ErmiteMultiTask
