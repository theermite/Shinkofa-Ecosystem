/**
 * LastHitTrainer - Web Component Entry Point
...
import { LastHitTrainer } from './LastHitTrainer'
...
class ErmiteLastHitTrainer extends HTMLElement {
  private root: Root | null = null
  private mountPoint: HTMLDivElement | null = null

  static get observedAttributes() {
    return ['user-id', 'difficulty', 'api-endpoint', 'auto-submit', 'duration']
  }
  ...
  private getProps() {
    return {
      ...
      gameDuration: parseInt(this.getAttribute('duration') || '60', 10),
    }
  }
  ...
  private render() {
    ...
    this.root.render(
      React.createElement(LastHitTrainer, {
        ...props,
...
if (!customElements.get('ermite-last-hit-trainer')) {
  customElements.define('ermite-last-hit-trainer', ErmiteLastHitTrainer)
}

export { LastHitTrainer } from './LastHitTrainer'
export default ErmiteLastHitTrainer
