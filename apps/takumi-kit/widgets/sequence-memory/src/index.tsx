/**
 * SequenceMemory - Web Component Entry Point
...
class ErmiteSequenceMemory extends HTMLElement {
  ...
  private render() {
    ...
    this.root.render(
      React.createElement(SequenceMemory, {
        ...props,
...
if (!customElements.get('ermite-sequence-memory')) {
  customElements.define('ermite-sequence-memory', ErmiteSequenceMemory)
}

export { SequenceMemory } from './SequenceMemory'
export default ErmiteSequenceMemory
