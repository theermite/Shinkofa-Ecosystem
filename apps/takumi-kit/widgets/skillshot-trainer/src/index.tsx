/**
 * SkillshotTrainer - Web Component Entry Point
...
import { SkillshotTrainer } from './SkillshotTrainer'
...
class ErmiteSkillshotTrainer extends HTMLElement {
  private root: Root | null = null
  private mountPoint: HTMLDivElement | null = null

  static get observedAttributes() {
    return ['user-id', 'difficulty', 'api-endpoint', 'auto-submit', 'shots']
  }
  ...
  private getProps() {
    return {
      ...
      totalShots: parseInt(this.getAttribute('shots') || '15', 10),
    }
  }
  ...
  private render() {
    ...
    styles.textContent = `
      ...
      :host { display: block; width: 100%; height: 100%; min-height: 550px; }
    ...
    this.root.render(
      React.createElement(SkillshotTrainer, {
        ...props,
...
if (!customElements.get('ermite-skillshot-trainer')) {
  customElements.define('ermite-skillshot-trainer', ErmiteSkillshotTrainer)
}

export { SkillshotTrainer } from './SkillshotTrainer'
export default ErmiteSkillshotTrainer
