/**
 * TrackingFocus - Web Component Entry Point
...
import { TrackingFocus } from './TrackingFocus'
...
class ErmiteTrackingFocus extends HTMLElement {
  ...
  private getProps() {
    return {
      ...
      gameDuration: parseInt(this.getAttribute('duration') || '30', 10),
    }
  }
  ...
  private render() {
    ...
    this.root.render(
      React.createElement(TrackingFocus, {
        ...props,
...
if (!customElements.get('ermite-tracking-focus')) {
  customElements.define('ermite-tracking-focus', ErmiteTrackingFocus)
}

export { TrackingFocus } from './TrackingFocus'
export default ErmiteTrackingFocus
