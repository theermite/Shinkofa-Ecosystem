/**
 * DodgeMaster - Web Component Entry Point
...
import { DodgeMaster } from './DodgeMaster'
...
class ErmiteDodgeMaster extends HTMLElement {
  ...
  private render() {
    ...
    this.root.render(
      React.createElement(DodgeMaster, {
        ...props,
...
if (!customElements.get('ermite-dodge-master')) {
  customElements.define('ermite-dodge-master', ErmiteDodgeMaster)
}

export { DodgeMaster } from './DodgeMaster'
export default ErmiteDodgeMaster
