/**
 * PatternRecall - Web Component Entry Point
...
class ErmitePatternRecall extends HTMLElement {
  ...
  private render() {
    ...
    this.root.render(
      React.createElement(PatternRecall, {
        ...props,
...
if (!customElements.get('ermite-pattern-recall')) {
  customElements.define('ermite-pattern-recall', ErmitePatternRecall)
}

export { PatternRecall } from './PatternRecall'
export default ErmitePatternRecall
