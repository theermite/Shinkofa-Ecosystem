/**
 * Breathing Exercise - Web Component Entry Point
...
import type { WidgetScore } from '../../../shared/types'

class ErmiteBreathingExercise extends HTMLElement {
  private root: Root | null = null
  private mountPoint: HTMLDivElement | null = null

  static get observedAttributes() {
    return ['user-id', 'api-endpoint', 'auto-submit']
  }
  ...
  attributeChangedCallback() { if (this.root) this.render() }
  ...
  private render() {
    ...
    this.root.render(
      React.createElement(BreathingExercise, {
        ...props,
...
if (!customElements.get('ermite-breathing-exercise')) {
  customElements.define('ermite-breathing-exercise', ErmiteBreathingExercise)
}

export { BreathingExercise } from './BreathingExercise'
export default ErmiteBreathingExercise
