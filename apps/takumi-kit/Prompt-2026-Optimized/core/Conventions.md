...
### Principe : Documentation FR, Code EN

| Contexte | Langue | Raison |
|----------|--------|--------|
| **Documentation** | Français | Audience principale francophone |
| **Code source** | Anglais | Standard industrie, collaboration |
| **Commits** | Anglais | Conventions universelles |
| **Comments code** | Anglais | Cohérence avec le code |
| **UI/UX textes** | Français (ou i18n) | Utilisateurs francophones |

### Règles Documentation

| Élément | Langue | Exemple |
|---------|--------|---------|
| README projet | FR | "Guide d'installation" |
| Fichiers CLAUDE.md | FR | "Workflow Standard" |
| Quickrefs | FR | "Référence rapide" |
| API docs techniques | EN | "Returns a User object" |
...
# ❌ Incorrect
def creer_utilisateur(courriel: str) -> Utilisateur:
    """Crée un nouvel utilisateur avec le courriel donné."""
    pass
```

### Termes Techniques

Garder les termes techniques en anglais même dans la doc FR :

| ✅ Garder EN | ❌ Traduire |
|-------------|-------------|
| "endpoint API" | "point de terminaison" |
| "commit" | "validation" |
| "deploy" | "déploiement" |
...
|----------|--------|
| Logs techniques | EN |
| Erreurs utilisateur | FR (ou i18n) |
| Exceptions internes | EN |

```python
# Logs techniques (EN)
logger.error("Failed to connect to database")

# Erreur utilisateur (FR)
