...
**Objectif** : 70%+ taux réutilisation (éviter 70%+ doublons potentiels)

**Tracking recommandé** :
- Nombre checks effectués
- % REUSE recommandés
- % REFACTOR recommandés
- % CREATE validés
- Temps gagné estimé
...
**Pour Jay** :
- ✅ Demande `/check-duplicate` systématiquement avant feature
- ✅ Fais confiance aux résultats (recherche exhaustive)
- ✅ Si hésitation entre REUSE et CREATE → Préfère REUSE

**Pour TAKUMI** :
- ✅ Recherche VRAIMENT (pas de fake confidence)
- ✅ Lis contexte code (pas juste nom fonction)
- ✅ Évalue qualité existant honnêtement
- ✅ Si recommande REUSE, montre code utilisable directement

---

## 🔗 Intégration Exomondo

**Inspiré de** : `claude-methodology-exomondo/methodology/commands/check-duplicate.md`

**Adaptations Jay** :
- ✅ Recherche multi-niveaux (Lessons + Code + Registres futurs)
- ✅ Format recommandation clair (✅ REUSE / 🔄 REFACTOR / ✨ CREATE)
- ✅ Exemples concrets adaptés nos projets
- ✅ Philosophie Shinkofa : Réutiliser excellence avant recréer

---

**Version** : 2.0.0
**Créé** : 2026-01-26
**Mis à jour** : 2026-01-28
**Impact** : CRITIQUE - Évite duplication code
**Agent** : Code-Reviewer
**Philosophie** : Shinkofa — Réutiliser l'excellence avant recréer
