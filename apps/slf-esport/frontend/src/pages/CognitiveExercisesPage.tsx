 ...
 *
 * Main page displaying all brain training exercises organized by category
 */
...
const CognitiveExercisesPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto mb-8">
        ...
        {/* Search & Filters */}
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-medium p-6 mb-8">
...
const ExerciseCard: React.FC<ExerciseCardProps> = ({ exercise }) => {
  ...
  return (
    <Link
      to={`/exercises/cognitive/${exercise.id}`}
      className="group block bg-white dark:bg-gray-800 rounded-2xl shadow-medium hover:shadow-strong transition-all duration-300 overflow-hidden"
    >
      {/* Thumbnail */}
...
export default CognitiveExercisesPage
